...
export class CategoryProductComponent implements OnInit {
  ...
  u_id : any
  constructor(private product: ProductService, private trusturl: DomSanitizer, @Inject('BASE_IMAGE_URL') _imageurl: any, private router: Router, private route : ActivatedRoute,private userdata : UserdataService,private wish : WishlistService, private toastr : ToastrService, private spinner : NgxSpinnerService) {
  ...
  customergetproductbycategory() {
    this.spinner.show()
    this.product.customergetproductbysubcategory(this.id).subscribe(
      (res: any) => {
        this.spinner.hide()
